...
I'll probably add the option to embed user information in `get_runs` to make that a little easiert, because currently you either have to do a lot of api calls or do a cumbersome setup to get your usernames in a `runs` dataset.
